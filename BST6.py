# ================================================================
# Binary Search Tree Assignment – Full Implementation
# Author: Rahul Khanna
# GitHub: https://github.com/SociallyRK
# Created: July 2025
#
# Developed with support from ChatGPT (OpenAI) for advanced Python 
# structuring and best practices.
#
# Key Data Architecture, including:
# ✅ 1. Dictionary-Based Dispatch Instead of If-Else
#    - Used to route insert direction without branching logic
#    - Prepares the codebase for trinary/N-ary expansion
#
# ✅ 2. Generalized `find()` with Tracker and State
#    - Supports traversal-specific search (e.g., findSmallest, sumSmaller)
#    - State dict tracks progress across recursion
#
# ✅ 3. Traversal Abstraction for Code Reuse
#    - Modularizes in/pre/post/level traversals
#    - Enables clean extension for printing or aggregation
...
# ✅ Sum of first k smallest values
